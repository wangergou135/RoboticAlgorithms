...
It samples from the current particle set 𝑁 times, 
...
If 𝑁̂_eff falls below some threshold it is time to resample. 
A useful starting point is 𝑁/2, but this varies by problem. 
'''
def neff(weights):
